...
USER_NAME = os.environ['USER_NAME'] # 'nizarelidrysy'
...
if __name__ == '__main__':
    """
    Customized Terminal Layout Generator
    """
    ...
    # Correctly calculates your age readout dynamically
    ...
    # Cleaned up: Removed the hardcoded archive block that causes file errors on fresh forks
